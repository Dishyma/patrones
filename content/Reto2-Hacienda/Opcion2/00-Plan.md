...
| Código refactorizado según el TO-BE | **Equipo** (guiado por [[Reto2-Hacienda/Opcion2/09-VistaTecnica]]) | Debe compilar y ejecutar; si no, criterio 4 = 0.0 |
...
> El enunciado define 4 frentes (Arquitecto Líder, Verificación, Riesgos y despliegue, Comunicación gráfica). Si el equipo son 3 integrantes, uno asume dos frentes — decisión del equipo que debe quedar registrada en [[Reto2-Hacienda/Opcion2/10-BitacoraIA]].
...
|---|----------|------|------------------|
| 1 | Detección de puntos de dolor | 15 % | [[Reto2-Hacienda/Opcion2/02-PuntosDolor]] |
| 2 | Decisión de patrones + criterio frente a la IA | 20 % | [[Reto2-Hacienda/Opcion2/03-PatronesEvaluados]] · [[Reto2-Hacienda/Opcion2/04-DecisionesArquitectonicas]] · [[Reto2-Hacienda/Opcion2/10-BitacoraIA]] |
| 3 | Diseño TO-BE (qué sale, qué entra, relaciones, impacto) | 20 % | [[Reto2-Hacienda/Opcion2/05-TOBE]] |
| 4 | Garantía de SOLID y del comportamiento | 15 % | [[Reto2-Hacienda/Opcion2/06-VerificacionSOLID]] |
| 5 | Análisis de riesgos | 15 % | [[Reto2-Hacienda/Opcion2/07-Riesgos]] |
| 6 | Las dos vistas y la sustentación | 15 % | [[Reto2-Hacienda/Opcion2/08-VistaNegocio]] · [[Reto2-Hacienda/Opcion2/09-VistaTecnica]] |
...
| [[Reto2-Hacienda/Opcion2/01-AS-IS]] | Arquitectura actual: capas, clases, dependencias, flujo de ensamblaje | Base de A1 | ✅ |
| [[Reto2-Hacienda/Opcion2/02-PuntosDolor]] | Inventario P-XX con evidencia, costo medido y decisión de intervención | A1 | ✅ (equipo aprobó 9 a intervenir) |
| [[Reto2-Hacienda/Opcion2/03-PatronesEvaluados]] | Ficha completa de los 22 patrones del Anexo A | A2 (tabla 2.1) | ✅ |
| [[Reto2-Hacienda/Opcion2/04-DecisionesArquitectonicas]] | Tabla de decisión: adoptados (3–5) y descartes argumentados | A2 | ✅ (pendiente aprobación del trío adoptado) |
| [[Reto2-Hacienda/Opcion2/05-TOBE]] | Diagramas por capas AS-IS/TO-BE, tabla de cambio E-XX, fichas de adoptados | A3 | ✅ |
| [[Reto2-Hacienda/Opcion2/06-VerificacionSOLID]] | Matriz patrón×principio con evidencia + 12 casos de comportamiento | A4 | ✅ |
| [[Reto2-Hacienda/Opcion2/07-Riesgos]] | Registro de riesgos (condición→consecuencia, P×I, señal observable) | A5 | ✅ |
| [[Reto2-Hacienda/Opcion2/08-VistaNegocio]] | Vista para la Líder Técnica (cero jerga técnica) | A6 | ✅ |
| [[Reto2-Hacienda/Opcion2/09-VistaTecnica]] | Vista para el dev nuevo + guía de dónde tocar (≥5 filas, cubre las 3 SC) | A6 | ✅ |
| [[Reto2-Hacienda/Opcion2/10-BitacoraIA]] | Registro de decisiones frente a la IA (mín. 10, reales) | Transversal | ✅ 17 registros |
...
### Fase 2 — Puntos de dolor ([[Reto2-Hacienda/Opcion2/02-PuntosDolor]])
...
### Fase 3 — Evaluación de patrones ([[Reto2-Hacienda/Opcion2/03-PatronesEvaluados]] · [[Reto2-Hacienda/Opcion2/04-DecisionesArquitectonicas]])
...
### Fase 4 — Verificación SOLID ([[Reto2-Hacienda/Opcion2/06-VerificacionSOLID]])
...
### Fase 5 — Riesgos ([[Reto2-Hacienda/Opcion2/07-Riesgos]])
...
### Fase 6 — Vistas ([[Reto2-Hacienda/Opcion2/08-VistaNegocio]] · [[Reto2-Hacienda/Opcion2/09-VistaTecnica]])
...
### Bitácora ([[Reto2-Hacienda/Opcion2/10-BitacoraIA]]) — transversal
...
| 31 ago | AS-IS y puntos de dolor; el equipo selecciona y decide D-01 | [[Reto2-Hacienda/Opcion2/01-AS-IS]] · [[Reto2-Hacienda/Opcion2/02-PuntosDolor]] |
| 1 sept | Evaluación de los 22 patrones + tabla de decisión | [[Reto2-Hacienda/Opcion2/03-PatronesEvaluados]] · [[Reto2-Hacienda/Opcion2/04-DecisionesArquitectonicas]] |
| 2 sept | TO-BE: diagramas, tabla de cambio, fichas | [[Reto2-Hacienda/Opcion2/05-TOBE]] |
| 3 sept | Verificación SOLID + riesgos | [[Reto2-Hacienda/Opcion2/06-VerificacionSOLID]] · [[Reto2-Hacienda/Opcion2/07-Riesgos]] |
| 4 sept | Vistas + bitácora al día; **el equipo empieza implementación** | [[Reto2-Hacienda/Opcion2/08-VistaNegocio]] · [[Reto2-Hacienda/Opcion2/09-VistaTecnica]] · [[Reto2-Hacienda/Opcion2/10-BitacoraIA]] |
...
| Comportamiento observable cambia sin querer | Diferencias en las salidas de los 8 casos del Reto 1 | Casos lado a lado en [[Reto2-Hacienda/Opcion2/06-VerificacionSOLID]] antes de dar por cerrado el TO-BE |
| Patrón adoptado por gusto | No hay P-XX que lo ancle | Regla de oro 1; revisión cruzada equipo ↔ IA en la bitácora |
| La vista de negocio se llena de jerga | Aparece cualquier nombre de patrón/clase/sigla | Checklist de palabras prohibidas en [[Reto2-Hacienda/Opcion2/08-VistaNegocio]] |

> [!tip] Navegación
> Siguiente documento: [[Reto2-Hacienda/Opcion2/01-AS-IS]] · Inventario de dolor: [[Reto2-Hacienda/Opcion2/02-PuntosDolor]] · Patrones: [[Reto2-Hacienda/Opcion2/03-PatronesEvaluados]] · Decisiones: [[Reto2-Hacienda/Opcion2/04-DecisionesArquitectonicas]] · Diseño: [[Reto2-Hacienda/Opcion2/05-TOBE]] · Verificación: [[Reto2-Hacienda/Opcion2/06-VerificacionSOLID]] · Riesgos: [[Reto2-Hacienda/Opcion2/07-Riesgos]] · Vistas: [[Reto2-Hacienda/Opcion2/08-VistaNegocio]] / [[Reto2-Hacienda/Opcion2/09-VistaTecnica]] · Bitácora: [[Reto2-Hacienda/Opcion2/10-BitacoraIA]]
